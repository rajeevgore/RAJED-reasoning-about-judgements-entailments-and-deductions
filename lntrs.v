...
{ stage12altdsR H0 H1 qin1 qin3 pr ; solve_eqs ;
rewrite (app_assoc l1) ; reflexivity.  }

{ stage12altdsR H0 H1 qin1 qin3 pr ; solve_eqs ;
rewrite (app_assoc ser) ; reflexivity.  }

{ stage12altdsR H0 H1 qin1 qin3 pr. }

{ stage12altdsR H0 H1 qin1 qin3 pr ; solve_eqs ; reflexivity. }
